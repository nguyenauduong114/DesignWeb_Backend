...
if (isset($_GET['mau_id'])|| $_GET['mau_id']!=null){
    ...
    $get_mau = $color -> get_mau($mau_id);
    if($get_mau){
        $resultA = $get_mau -> fetch_assoc(); 
    }
?>
...
<?php 
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $update_img = $color ->update_img($mau_ten, $color_anh, $mau_id); //ham da duoc dinh nghia ben beand_class
        ...
        <div class="admin-content-right">
            <div class="cartegory-add-content">
                ...
                <!-- action file chèn biến bên dưới vào -->
                    ...
                    <img style="width: 50px"; height="50px"; src="uploads/<?php echo $resultA['anh_ten']?>" alt=""> <br>
                    <input type="file" name="anh_ten"> <br>
